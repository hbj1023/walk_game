...
const currentChapter2ArmorPrices = {
  common: { helmet: 520, armor: 680, shoes: 520 },
  rare: { helmet: 700, armor: 900, shoes: 700 },
  epic: { helmet: 3600, armor: 4400, shoes: 3600 },
}

const balancedChapter2ArmorPrices = {
...
migrate((app) => {
  syncChapter2ArmorPrices(app, balancedChapter2ArmorPrices)
}, (app) => {
  syncChapter2ArmorPrices(app, currentChapter2ArmorPrices)
})
