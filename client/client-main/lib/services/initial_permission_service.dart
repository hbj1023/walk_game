...
class InitialPermissionService {
  ...
  static Future<bool> shouldShow() async {
    ...
    final activityGranted =
        await ActivityRecognitionPermissionService.checkGranted();
    final needsAndroidNotification =
        defaultTargetPlatform == TargetPlatform.android &&
        !(prefs.getBool(_notificationRequestedKey) ?? false);
    return !initialCompleted || !activityGranted || needsAndroidNotification;
  }
  ...
  static Future<bool> _requestActivityPermission() async {
    ...
    if (defaultTargetPlatform == TargetPlatform.android) {
      return ActivityRecognitionPermissionService.ensureGranted();
    }
